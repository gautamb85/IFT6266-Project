...
class _netG(nn.Module):
    ...
    def forward(self, input):
        ...
        gpu_ids=[0]
        gpu_ids = np.asarray(gpu_ids,dtype='int32')
...
#data stuff
train_set = H5PYDataset('/misc/data15/reco/bhattgau/Rnn/code/Code_/mscoco/cocotrain/inpainting/mscoco-train-torch2.hdf5',which_sets=('train',))
